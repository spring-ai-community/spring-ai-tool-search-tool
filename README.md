...
> **NOTE:** this is a Spring AI 2.x (Boot 4 / Framework 7) compatibible version.

>For Spring AI 1.1.x (Boot 3/Framework 6)  compatible veriosn visit: [Tool Search Tool v1.0.x](https://github.com/spring-ai-community/spring-ai-tool-search-tool/tree/1.0.x)
