...
> _**NOTE:** this is Spring AI 1.1.x / Boot 3 compatibible version. For Spring AI 2.x / Boot 4 switch to: [Tool Search Tool - v2.0.x](https://github.com/spring-ai-community/spring-ai-tool-search-tool)_

Dynamic tool discovery and selection for Spring AI, enabling LLMs to work efficiently with large tool libraries by discovering tools on-demand instead of loading all definitions upfront. For itroduction check the [Smart Tool Selection](https://spring.io/blog/2025/12/11/spring-ai-tool-search-tools-tzolov) blog.
